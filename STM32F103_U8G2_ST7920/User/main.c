...
int main(void)
{
  ...
  u8g2_Setup_st7920_s_128x64_2(&u8g2, U8G2_R0, u8x8_byte_stm32_sw_spi, u8x8_gpio_and_delay_stm32); //注册屏幕的回调函数
...
//  u8g2_SetFontMode(&u8g2, 0);
  ...
  u8g2_SetFontDirection(&u8g2, 0);// setFontDirection(0);
...

  {
    ...
    st_Step(y, /* is_auto_fire */ 0, /* is_fire */ KEY_M);
